...
%.o: %.c $(HEADERS)/$(NAME).h
	@echo "\033[32mCorawar  :\033[0m [Compilation:\033[33m $@\033[0m]"
...
$(NAME): $(SRCO)
	...
	@echo "[\033[32m--------------------------\033[0m]"
	@echo "[\033[36m------ OK - Corawar ------\033[0m]"
	@echo "[\033[32m--------------------------\033[0m]"
...
clean:
	@echo "\033[32mCorawar :\033[0m [\033[31mSuppression des .o\033[0m]"
...
fclean:
	@echo "\033[32mCorawar :\033[0m [\033[31mSuppression des .o\033[0m]"
	@rm -f $(SRCO)
	@echo "\033[32mCorawar :\033[0m [\033[31mSuppression de $(NAME)\033[0m]"
